...
function HighlightedProvider({
  ...
  const seriesById = React2.useMemo(() => {
  ...
  const providerValue = React2.useMemo(() => {
    return {
      isInitialized: true,
      data: {
        highlightScope,
...
function useHighlighted() {
  const {
    isInitialized,
    data
  } = React3.useContext(HighlightedContext);
  if (!isInitialized) {
...
function ChartsXAxis(inProps) {
  ...
  return (0, import_jsx_runtime4.jsxs)(AxisRoot, {
    ...
    children: [!disableLine && (0, import_jsx_runtime5.jsx)(Line, _extends({
      ...
      return (0, import_jsx_runtime5.jsxs)("g", {
        ...
        children: [!disableTicks && (0, import_jsx_runtime5.jsx)(Tick, _extends({
          ...
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && (0, import_jsx_runtime5.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: formattedValue.toString()
        }, axisTickLabelProps))]
      }, index);
    }), label && (0, import_jsx_runtime5.jsx)("g", {
      className: classes.label,
...
var ColorContext = React15.createContext({});
if (true) {
...
function ColorProvider(props) {
  ...
  return (0, import_jsx_runtime8.jsx)(ColorContext.Provider, {
...
function useColorProcessor(seriesType) {
  const colorProcessors = React16.useContext(ColorContext);
  if (!seriesType) {
...
true ? ChartsItemTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types7.default.shape({
    classes: import_prop_types7.default.object,
    getColor: import_prop_types7.default.func,
    itemData: import_prop_types7.default.shape({
      ...
      type: import_prop_types7.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired
    }),
    series: import_prop_types7.default.object,
...
function DefaultChartsAxisTooltipContent(props) {
  ...
  return (0, import_jsx_runtime11.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.root,
    children: (0, import_jsx_runtime11.jsxs)(ChartsTooltipTable, {
      className: classes.table,
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime11.jsx)("thead", {
        ...
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime11.jsxs)(ChartsTooltipRow, {
            ...
            children: [(0, import_jsx_runtime11.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.markCell, classes.cell),
              children: color && (0, import_jsx_runtime11.jsx)(ChartsTooltipMark, {
                color,
                className: classes.mark
              })
            }), (0, import_jsx_runtime11.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.labelCell, classes.cell),
              children: formattedLabel ? (0, import_jsx_runtime11.jsx)(Typography_default, {
...
true ? ChartsAxisTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types10.default.shape({
    axis: import_prop_types10.default.object,
    axisData: import_prop_types10.default.shape({
      x: import_prop_types10.default.shape({
        index: import_prop_types10.default.number,
        value: import_prop_types10.default.oneOfType([import_prop_types10.default.instanceOf(Date), import_prop_types10.default.number, import_prop_types10.default.string]).isRequired
    ...
    series: import_prop_types10.default.arrayOf(import_prop_types10.default.object),
...
var Portal = React22.forwardRef(function Portal2(props, forwardedRef) {
  ...
  if (disablePortal) {
    ...
    return (0, import_jsx_runtime13.jsx)(React22.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime13.jsx)(React22.Fragment, {
...
function DefaultChartsLegend(props) {
  ...
  const [seriesWithPosition, legendWidth, legendHeight] = React26.useMemo(() => {
    let x = 0;
    let y = 0;
  ...
  return (0, import_jsx_runtime17.jsx)(NoSsr, {
    children: (0, import_jsx_runtime17.jsx)(ChartsLegendRoot, {
      className: classes.root,
  ...
  return (0, import_jsx_runtime20.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold, index) => {
      ...
      return (0, import_jsx_runtime20.jsxs)(React29.Fragment, {
        children: [(0, import_jsx_runtime20.jsx)("stop", {
          offset: offset2,
          stopColor: colorMap.colors[index],
          stopOpacity: 1
        }), (0, import_jsx_runtime20.jsx)("stop", {
          offset: offset2,
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react9.forwardRef)((givenProps, givenRef) => {
    ...
    return React33.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React34.createElement(Provider, { value: props }, children);
};
var ctx = makeContext(SpringContext, {});
SpringContext.Provider = ctx.Provider;
SpringContext.Consumer = ctx.Consumer;
function makeContext(target, init) {
  Object.assign(target, React34.createContext(init));
...
var ChartContainer = React36.forwardRef(function ChartContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime23.jsx)(DrawingProvider, {
    width,
    height,
    margin,
    svgRef,
    children: (0, import_jsx_runtime23.jsx)(ColorProvider, {
      colorProcessors,
      children: (0, import_jsx_runtime23.jsx)(SeriesContextProvider, {
        series,
        colors: colors3,
        dataset,
        seriesFormatters,
        children: (0, import_jsx_runtime23.jsx)(CartesianContextProvider, {
          xAxis,
          yAxis,
          dataset,
          xExtremumGetters,
          yExtremumGetters,
          children: (0, import_jsx_runtime23.jsx)(ZAxisContextProvider, {
            zAxis,
            dataset,
            children: (0, import_jsx_runtime23.jsx)(InteractionProvider, {
              children: (0, import_jsx_runtime23.jsx)(HighlightedProvider, {
                highlightedItem,
                onHighlightChange,
                children: (0, import_jsx_runtime23.jsxs)(ChartsSurface, {
                  width,
                  height,
                  ref: handleRef,
                  sx,
...
var ResponsiveChartContainer = React37.forwardRef(function ResponsiveChartContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime24.jsx)(ResizableContainer, {
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    },
    children: width && height ? (0, import_jsx_runtime24.jsx)(ChartContainer, _extends({}, other, {
      width,
      height,
      ref
    })) : null
...
//# sourceMappingURL=chunk-T32AABNU.js.map
