...
import {
  ...
  useSeries,
  useTheme
} from "./chunk-A34Y4JUX.js";
import {
  Typography_default
} from "./chunk-4TLB2DDG.js";
import {
  HTMLElementType,
  chainPropTypes,
  exactProp,
...
} from "./chunk-TV2XF2BA.js";
import {
  setRef,
  useControlled,
  useForkRef
} from "./chunk-ZQS7SK6B.js";
import {
  _extends,
...
var ColorContext = React7.createContext({});
if (true) {
...
function ColorProvider(props) {
  ...
  return (0, import_jsx_runtime3.jsx)(ColorContext.Provider, {
...
var ChartContainer = React15.forwardRef(function ChartContainer2(props, ref) {
  const {
    width,
    height,
    series,
  ...
  return (0, import_jsx_runtime7.jsx)(DrawingProvider, {
    ...
    margin,
    svgRef,
    children: (0, import_jsx_runtime7.jsx)(ColorProvider, {
      colorProcessors,
      children: (0, import_jsx_runtime7.jsx)(SeriesContextProvider, {
        ...
        children: (0, import_jsx_runtime7.jsx)(CartesianContextProvider, {
          ...
          xExtremumGetters,
          yExtremumGetters,
          children: (0, import_jsx_runtime7.jsx)(ZAxisContextProvider, {
            zAxis,
            dataset,
...
var ResponsiveChartContainer = React16.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight
      ...
      children: (0, import_jsx_runtime9.jsx)("tbody", {
        children: (0, import_jsx_runtime9.jsxs)(ChartsTooltipRow, {
          ...
          children: [(0, import_jsx_runtime9.jsx)(ChartsTooltipCell, {
            ...
            children: (0, import_jsx_runtime9.jsx)(ChartsTooltipMark, {
              color,
...
function useColorProcessor(seriesType) {
  const colorProcessors = React18.useContext(ColorContext);
  if (!seriesType) {
...
true ? ChartsAxisTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types8.default.shape({
    ...
    axisValue: import_prop_types8.default.oneOfType([import_prop_types8.default.instanceOf(Date), import_prop_types8.default.number, import_prop_types8.default.string]),
...
var _excluded4 = ["rotate", "dominantBaseline"];
...
function DefaultChartsLegend(props) {
  ...
  const getItemSpace = React28.useCallback((label, inStyle = {}) => {
    const style = _objectWithoutPropertiesLoose(inStyle, _excluded4);
  ...
  const [seriesWithPosition, legendWidth, legendHeight] = React28.useMemo(() => {
    let x = 0;
    let y = 0;
...
function ChartsLegend(inProps) {
  ...
  const theme = useTheme();
  const classes = useUtilityClasses3(_extends({}, props, {
    theme
  }));
...
//# sourceMappingURL=chunk-IIUXVGPP.js.map
